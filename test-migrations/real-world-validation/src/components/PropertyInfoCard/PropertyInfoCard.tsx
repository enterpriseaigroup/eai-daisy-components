...
interface Props {
  ...
  /**
   * BUSINESS LOGIC: PropertyInfoCard
   *
   * WHY THIS EXISTS:
   * - Implements business logic requirement
   *
   * WHAT IT DOES:
   * 1. Implements PropertyInfoCard logic
   * 2. Calls helper functions: useState, useProfileStore, getCouncilByName, getCouncilNameByEntraId, .includes, resolvedCouncilName.toLowerCase, .includes, resolvedCouncilName.toLowerCase, setOpen, console.log, hasValue, hasValue, hasValue, hasValue, hasValue, hasValue, hasValue, hasValue, hasValue, .replace, hasValue, hasValue, hasValue, hasValue, hasValue, hasValue, setShowReportModal, .setTriggerAddressCard, useProfileStore.getState
   ...
   * - resolvedCouncilName.toLowerCase() - Function call
   * - .includes() - Function call
   * - resolvedCouncilName.toLowerCase() - Function call
   * - setOpen() - Function call
   * - console.log() - Function call
   * - hasValue() - Function call
   * - hasValue() - Function call
   * - hasValue() - Function call
   * - hasValue() - Function call
   * - hasValue() - Function call
   ...
   * - .setTriggerAddressCard() - Function call
   ...
   * - resolvedCouncilName.toLowerCase: Required functionality
   * - .includes: Required functionality
   * - resolvedCouncilName.toLowerCase: Required functionality
   * - setOpen: State update
   * - console.log: Debugging output
   * - hasValue: Required functionality
   * - hasValue: Required functionality
   * - hasValue: Required functionality
   * - hasValue: Required functionality
   * - hasValue: Required functionality
   ...
   * - .setTriggerAddressCard: State update
   * - useProfileStore.getState: Required functionality
   *
   * DATA FLOW:
   * Input: Component state and props
   * Processing: Calls useState, useProfileStore, getCouncilByName to process data
